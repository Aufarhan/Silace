...
<section class="w-full bg-primary pt-6 pb-[6dvh]">
    <div class="background md:container  md:py-4 py-2 rounded-[1rem] ring-2 ring-slate-200 shadow-lg shadow-hitam/10 md:mx-auto mx-2">
