            ...
            <form method="post" action="/dashboard/categories/{{ $category->slug }}" enctype="multipart/form-data">
                ...
                <div class="space-y-6">
                    <div>
                        ...
                        <input type="text" value="{{ old('name', $category->name) }}" autofocus required name="name" id="title" class="@error('name')peer-invalid:visible border-red-700 @enderror peer bg-gray-50 border border-gray-200 rounded py-1 px-3 block focus:ring-blue-500 focus:border-blue-500 text-gray-700 w-full"/>
                        @error('name')
                    ...
                    <div>
                        ...
                        <input type="text" value="{{ old('slug', $category->slug) }}" name="slug" id="slug" class="peer bg-gray-50 border border-gray-200 rounded py-1 px-3 block focus:ring-blue-500 focus:border-blue-500 text-gray-700 w-full"/>
                        @error('slug')
                        <p class="peer-invalid:visible text-red-700">
                            {{ $message }}
                        </p>
